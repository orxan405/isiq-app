...
export const SocketProvider = ({ children }) => {
  ...
  const connectSocket = async () => {
    ...
    // Gələn zəng — state-ə yaz, _layout.jsx-də handle et
    socketRef.current.on('call:incoming', ({ matchId, callerId, type, callerName }) => {
      setIncomingCall({ matchId, callerId, type, callerName });
    });
  };
